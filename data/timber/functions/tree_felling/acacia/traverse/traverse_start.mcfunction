...
execute unless block ~ ~1 ~ #minecraft:acacia_logs[axis=y] run function timber:marker/make_branch

# Start traversal.
execute unless score #timber.item.durability timber.var matches 1 run function timber:tree_felling/acacia/traverse/traverse
